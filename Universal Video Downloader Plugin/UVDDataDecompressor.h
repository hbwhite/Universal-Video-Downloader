...
// This is a helper class used by UVDHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface UVDDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
